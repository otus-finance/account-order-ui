...
export type CreateToastOptions = ToastRenderOptions &
...
export function createToast(options: CreateToastOptions): string {
  ...
  const toastId = toast(
    ({ toastProps, closeToast }) => (
      <Toast
        variant={variant} // needed
        icon={icon} // needed
        description={description} // needed
        hrefLabel={hrefLabel} // needed
        href={href} // needed
        target={target} // needed
        toastProps={toastProps} // needed
        closeToast={closeToast} // needed
      />
    ),
    {
      ...toastOptions,
...
const ToastIcons = ({ icon }: { icon: ToastIcon | undefined }) => {
  switch (icon) {
