						...
						{data?.positions.map((position: Position, index: number) => {
							...
							return (
								<tr key={index} className="hover:bg-zinc-100 hover:dark:bg-zinc-900">
									...
									<td className="whitespace-nowrap py-4 text-xs font-medium dark:text-zinc-200">
										{txHref && (
...
const LyraPositions = () => {
	...
	return (
		<>
			<div className="border-b dark:border-zinc-900 pt-8 p-4 text-sm font-normal dark:text-zinc-200">
				Lyra Positions
			</div>
			...
			{isLyraPositionsLoading ? (
				...
				<table className="min-w-full  rounded-sm">
					<thead className="divide-b dark:divide-zinc-900 divide-zinc-300 ">
						<th scope="col" className=" py-3.5 text-left pl-4 text-xs font-light">
							Type
						</th>
						<th scope="col" className=" py-3.5 text-left pl-4 text-xs font-light">
