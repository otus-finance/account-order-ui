		...
		<div className="py-4 cursor-pointer">
			{isConnected && chain?.id != selectedChain?.id ? (
				<div
					...
					className="cursor-pointer  hover:border-emerald-600 p-2 py-3 col-span-3 font-semibold text-sm dark:text-white text-center rounded-full dark:bg-black hover:dark:bg-zinc-800 mb-2"
				>
					Wrong network
				</div>
			) : (
