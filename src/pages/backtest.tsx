                      ...
                      <Switch.Group as="div" className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          className={classNames(
                            enabled ? 'bg-emerald-600' : 'bg-dark-gray',
              ...
              <div className="mt-4 border border-1 border-zinc-700 px-4 py-5 sm:px-6">
                ...
                <button onClick={() => runTest()} className="btn w-full h-12 bg-emerald-600 text-zinc-900 font-sans font-bold">

                  {
                    loading ?
                      <>
                        <svg role="status" className="inline mr-3 w-4 h-4 text-zinc-900 animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
