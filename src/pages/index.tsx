        ...
        <div className="relative items-center justify-center w-full overflow-x-hidden sm:pt-4 md:pt-4">
          <div className="container flex flex-col items-center justify-between h-full max-w-6xl px-8 mx-auto lg:flex-row xl:px-0">
            <div className="w-full py-20 pl-10 pr-10 lg:w-5/12 lg:py-32 lg:pr-0 tails-selected-element">
              <h1 className="text-4xl font-mono font-bold leading-tight text-white sm:text-4xl lg:pr-10">
                <span className="relative inline-block">
                  The Decentralized Options Vaults Marketplace
                </span>
                <span className="block">Built on Lyra.</span>
              </h1>
              <p className="font-sans text-md font-light text-gray-600 sm:text-xl lg:pr-10 pt-10">
                Create or join the best performing options vaults.
              </p>
              <p className="font-sans mt-6 text-sm font-bold text-gray-600 lg:pr-10">
              ...
              <form className="flex justify-between w-full mt-4 border-1 border-white" onSubmit={handleSubmit}>
                <input
                  ...
                  className="flex-1 w-auto pl-2 text-sm text-gray-600 bg-zinc-700 outline-none focus:outline-none"
                  placeholder="Enter Your Email"
                />
                <button
                  type="submit"
                  className="font-sans px-6 py-2 text-sm font-bold text-zinc-900 bg-emerald-600 hover:bg-dark-gray hover:text-white"
                >
                  {
                    loading ?
                      <>
            ...
            <div className="flex items-center justify-between flex-wrap">
              <div className="w-0 flex-1 flex items-center">
                <span className="flex p-2 rounded-lg bg-emerald-600">
                  <SpeakerphoneIcon className="h-6 w-6 text-zinc-900" aria-hidden="true" />
                </span>
                <p className="ml-3 font-medium text-zinc-900 truncate">
